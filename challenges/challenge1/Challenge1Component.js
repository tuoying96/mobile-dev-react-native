...
class Challenge1Component extends Component {
  render() {
    return (
      <View>
        {"\n"}
        {"\n"}
        <Text>The following cute image component is for Challenge1</Text>
        <Image
...
export default Challenge1Component;
